...
CUSTOM_XFADE_TRANSITIONS = {
	...
	"diamondwipe": (
		"Wipe using an expanding diamond from the center. Engineering has been using it, and now we can too.",
		# By SenseAmidstMadness
		"if(lt(abs(X-W/2)/W+abs(Y-H/2)/H,pow(1-P,3)),B,A)",
	),
}

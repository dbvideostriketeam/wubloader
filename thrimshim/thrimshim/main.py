...
import common
from common import database, dateutil, requests, website
...
@request_stats
def get_challenges():
	if app.challenge_api is None:
		return "This server not configured with challenge api", 501
	return app.challenge_api.challenges()
...
def set_challenge_video(id, editor=None):
	...
	app.challenge_api.set_challenge_url(id, url)
	return "", 200
...
def main(
	...
	archive_sheet=None, archive_location=None, challenge_api_key=None,
):
	...
	app.challenge_api = website.Client(auth_token=challenge_api_key)
